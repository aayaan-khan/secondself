...
## Workflow Steps / Context Docs

- `problemStatement.md` → store the problem that you are solving
...
4. Generate an `edge-case.md` for storing all corner scenarios and edge-cases for this project using `@docs/architecture.md` and `@docs/Implementation-plan.md`
5. Implement Phase 0 as per the `@docs/Implementation-plan.md`
